...
/**
 * Deno Benchmark Runner for RemObj
 * 
 * Run with: deno run --allow-read benchmark/deno.ts
 * Or: npm run bench:deno
 * 
 * This runner uses the same test.js functions as the Node.js runner
 */
...
async function main() {
  ...
  console.log("╔══════════════════════════════════════════════════════════╗");
  console.log("║            RemObj Benchmark Suite (Deno)                  ║");
  console.log("╚══════════════════════════════════════════════════════════╝");
  ...
  console.log(`Platform: ${Deno.build.os} ${Deno.build.arch}${colors.reset}`);
  console.log();
  ...
  const validResults = results.filter(r => r !== null) as BenchmarkResult[];
